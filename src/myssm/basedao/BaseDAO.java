...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAO_exception("BaseDAO构造方法出错了，可能的原因是没有指定<>中的类型");
        }
    }
    ...
    protected int executeUpdate(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAO_exception("BaseDAO executeUpdate出错了");
        }
    ...
    private void setValue(Object obj, String property, Object propertyValue) throws NoSuchFieldException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException {
        ...
        if (field != null) {
            ...
            //如果是自己自定义的类型，则需要构造这个；类
            if (isMyType(typeName)) {
                //如果typeName是“UserBasic”
    ...
    private static boolean isNotMyType(String typeName) {
        return "java.lang.Integer".equals(typeName) || "java.lang.String".equals(typeName) || "java.util.Date".equals(typeName) || "java.sql.Date".equals(typeName) || "java.sql.Timestamp".equals(typeName);
    }
    ...
    protected Object[] executeComplexQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAO_exception("BaseDAO executeComplexQuery出错了");
        }
    ...
    protected T load(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAO_exception("BaseDAO load出错了");
        }
    ...
    protected List<T> executeQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAO_exception("BaseDAO executeQuery出错了");
        }
